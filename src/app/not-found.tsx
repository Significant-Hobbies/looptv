...
export default function NotFound() {
  return (
    <main className="mx-auto flex min-h-[60vh] max-w-md flex-col items-center justify-center px-6 text-center text-zinc-300">
      <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-zinc-500">404</p>
      <h1 className="mt-3 text-3xl font-medium tracking-tight text-white">Off air</h1>
